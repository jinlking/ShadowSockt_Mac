...
- (void)updatePACFromGFWList {
    [manager GET:@"https://autoproxy-gfwlist.googlecode.com/svn/trunk/gfwlist.txt" parameters:nil progress:nil success:^(NSURLSessionDataTask *task, id responseObject){
